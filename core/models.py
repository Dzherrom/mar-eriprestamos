...
class Clientes(models.Model):
    ...
    numero_local = models.CharField(max_length=15, default=None, blank=True, null=True)
    cedula = models.CharField(max_length=12)
    rif = models.CharField(max_length=13, default='V1234567890', blank=True, null=True)
    ...
    email_1 = models.EmailField(default=None, blank=True)  # Mandatory field
